...
test.describe('Teste do Crud de Passeio', () => {
    ...
    test('O usuário irá criar, listar, ataulizar e remover um passeio com sucesso', async ({ page }) => {
        ...
        await expect(page).toHaveURL('https://tripplanner.local/cadastro-passeio/1?data=2025-05-02%2000:00:00')
        ...
        await expect(page).toHaveURL('https://tripplanner.local/?data=2025-05-02%2000:00:00')
